...
FIGHTER = {
    ...
    'equipment': [
        ...
        ["Chain Armor", "Spear (1d8)", "Light Crossbow (1d6)", "Case With 30 Quarrels", "6 Torches", "Backpack", "Waterskin", "1 Week Iron Rations", "50' Rope", "11 gp"],
        ...
        ["Plate Armor", "Shield", "Sword (1d8)", "Light Crossbow (1d6)", "Case With 30 Quarrels", "6 Torches", "Backpack", "Waterskin", "1 Week Iron Rations", "10' Pole", "2 gp"],
        ...
        ["Plate Armor", "Shield", "Sword (1d8)", "Light Crossbow (1d6)", "Case With 30 Quarrels", "Backpack", "Waterskin", "Lantern", "4 Flasks oil", "1 Week Iron Rations", "10' Pole", "5 gp"],
        ["Plate Armor", "Helmet", "2 Battle Axes", "Dagger (1d4)", "Light Crossbow (1d6)", "Case With 30 Quarrels", "6 Torches", "Backpack", "Waterskin", "1 Week Iron Rations", "50' Rope", "5 Flasks oil", "15 gp"],
        ...
        ["Plate Armor", "Shield", "Helmet", "Sword (1d8)", "2 Daggers", "Light Crossbow (1d6)", "Case With 30 Quarrels", "4 Silver Tipped Quarrels", "Backpack", "Waterskin", "Lantern", "4 Flasks oil", "1 Week Iron Rations", "10' Pole", "9 gp"]
    ],
    'hitdice': 8,
    'saves': {
...
THIEF = {
    ...
    'equipment': [
        ...
        ["Cudgel", "Light Crossbow (1d6)", "Case With 30 Quarrels", "Leather Armor", "6 Torches", "Backpack", "Waterskin", "1 Week Iron Rations", "50' Rope", "6 gp"],
        ["Sword (1d8)", "Light Crossbow (1d6)", "Case of 30 Quarrels", "Leather Armor", "6 Torches", "Backpack", "Waterskin", "1 Week Iron Rations", "10' Pole", "7 gp"],
        ...
        ["Sword (1d8)", "Light Crossbow (1d6)", "Case of 30 Quarrels", "2 Silver Tipped Quarrels", "Leather Armor", "Backpack", "Waterskin", "Lantern", "4 Flasks oil", "1 Week Iron Rations", "50' Rope", "10 gp"],
        ...
        ["Sword (1d8)", "Light Crossbow (1d6)", "Case of 30 Quarrels", "6 Silver Tipped Quarrels", "Leather Armor", "Backpack", "Waterskin", "Lantern", "4 Flasks oil", "1 Week Iron Rations", "10' Pole", "20 gp"],
        ...
        ["Sword (1d8)", "Light Crossbow (1d6)", "Case of 30 Quarrels", "Leather Armor", "Backpack", "Waterskin", "Lantern", "4 Flasks oil", "1 Week Iron Rations", "50' Rope", "80 gp"],
...
#        ('Tinker', 0),
    ...
    'specialist_builds': [
        # all have 5 slots
        ['Sleight of Hand', 'Search', 'Stealth', 'Armory', 'Sneak Attack'],
        ['Acting', 'Sleight of Hand', 'Stealth', 'Forgery', 'Sneak Attack'],
        ['Bushcraft', 'Chirurgeon', 'History', 'Search', 'Sleight of Hand'],
        ['Search', 'Merchant', 'Appraiser', 'Sneak Attack', 'Forgery'],
        ['Cartography', 'Architecture', 'Stealth', 'Open Doors', 'Tinker'],
        ['Appraiser', 'Athletics', 'Open Doors', 'Search', 'Stealth'],
        ['Sleight of Hand', 'Deception', 'Open Doors', 'Athletics', 'Search'],
        ['Athletics', 'Stealth', 'Acting', 'Search', 'Sneak Attack'],
        ['Sleight of Hand', 'Stealth', 'Athletics', 'Search', 'Sneak Attack'],
        ['Tinker', 'Armory', 'Forgery', 'Sneak Attack', 'Stealth'],
        ['Appraiser', 'Acting', 'Stealth', 'Merchant', 'Search'],
        ['Tinker', 'Architecture', 'Appraiser', 'History', 'Search'],
        ['Bushcraft', 'Languages', 'Open Doors', 'Tinker', 'Stealth'],
...
LOTFP = {
    ...
    'equipment': {
        'Thief': [
            ["Dagger (1d4)", "Specialist Tools", "Garrote (1d2)", "Waterskin", "Rucksack", "5x Rations", "Pot of Lard", "10 sp"],
            ["Shortsword (1d6)", "Specialist Tools", "Waterskin", "Small Backpack", "50' Rope", "5x Rations", "Crowbar", "8 Cp"],
            ...
            ["Dagger (1d4)", "Leather Armor", "Specialist Tools", "3 Torches", "Waterskin", "Small Backpack", "Tinderbox", "50' Rope", "5x Rations", "Crowbar", "11 Cp"],
            ["Shortsword (1d6)", "Leather Armor", "Specialist Tools", "Garrote (1d2)", "3 Torches", "Waterskin", "Small Backpack", "Tinderbox", "50' Rope", "5x Rations", "1 sp, 11 Cp"],
            ["Sword (1d8)", "Leather Armor", "Specialist Tools", "Garrote (1d2)", "3 Torches", "Waterskin", "Small Backpack", "Tinderbox", "50' Rope", "Listening Horn", "5x Rations", "Crowbar", "11 Cp"],
            ...
            ["Shortbow (1d6)", "Shortsword (1d6)", "Leather Armor", "Specialist Tools", "Garrote (1d2)", "3 Torches", "Waterskin", "Small Backpack", "Small Drill", "Tinderbox", "50' Rope", "Quiver - 4 Arrows", "5x Rations", "1 Cp"],
            ["Light Crossbow (1d6)", "Dagger (1d4)", "Leather Armor", "Specialist Tools", "Hooded Lantern", "Waterskin", "Large Backpack", "Tinderbox", "50' Rope", "Quiver - 16 Bolts", "5x Rations", "1 Cp"],
            ["Shortbow (1d6)", "Quiver With 20 Arrows", "Shortsword (1d6)", "Leather Armor", "Specialist Tools", "Garrote (1d2)", "Lamp", "Waterskin", "Small Backpack", "Tinderbox", "Grappling Hook", "50' Rope", "5x Rations", "Crowbar", "Steel Mirror", "11 Cp"],
        ...
        'Cleric': [
            ["Spear (1d8)", "Shield", "Large Knife (1d4)", "Waterskin", "Rucksack", "5x Rations", "3 Cp"],
            ["Spear (1d8)", "Shield", "Mace (1d6)", "Waterskin", "Small Backpack", "Incense Burner", "Tinderbox", "50' Rope", "3x Rations", "5x Iron Spike", "4 Cp"],
            ["Spear (1d8)", "Shield", "Dagger (1d4)", "Leather Armor", "5x Rations", "50' Rope", "Waterskin", "Small Backpack", "5x Iron Spike", "3 Cp"],
            ...
            ["Light Crossbow (1d6)", "Quiver With 20 Bolts", "Chain Armor", "Dagger (1d4)", "5x Rations", "Hooded Lantern", "Tinderbox", "50' Rope", "Waterskin", "Small Backpack", "5x Iron Spike", "5 Cp"],
            ["Spear (1d8)", "Shield", "Shortsword (1d6)", "Chain Armor", "5x Rations", "Lamp", "Tinderbox", "50' Rope", "3 Flasks of Oil", "Waterskin", "Large Backpack", "5x Iron Spike", "7 Cp"],
        ...
        'Fighter': [
            ...
            ["Warhammer (1d8)", "Shield", "Shortsword (1d6)", "Dagger (1d4)", "Leather Armor", "5x Rations", "3 Torches", "Tinderbox", "50' Rope", "Waterskin", "Small Backpack", "5x Iron Spike", "1 Cp"],
            ["Heavy Crossbow (1d8)", "Quiver With 20 Bolts", "Leather Armor", "Shortsword (1d6)", "Dagger (1d4)", "5x Rations", "Lamp", "Tinderbox", "50' Rope", "Waterskin", "Small Backpack", "5x Iron Spike", "Shortbow (1d6)", "Quiver With 10 Arrows", "1 Cp"],
            ["Greataxe (1d10)", "Dagger (1d4)", "Leather Armor", "5x Rations", "Lamp", "Tinderbox", "50' Rope", "Waterskin", "Large Backpack", "5x Iron Spike", "Shortbow (1d6)", "Quiver With 20 Arrows", "1 Cp"],
            ["Battleaxe (1d8)", "Shield", "Sword (1d8)", "Leather Armor", "5x Rations", "Lamp", "Tinderbox", "50' Rope", "Waterskin", "Small Backpack", "5x Iron Spike", "Longbow (1d8)", "Quiver With 10 Arrows", "1 Cp"],
            ["Great Spear (1d10)", "Shield", "Sword (1d8)", "Leather Armor", "5x Rations", "3 Torches", "Tinderbox", "50' Rope", "Waterskin", "Large Backpack", "5x Iron Spike", "Longbow (1d8)", "Quiver With 20 Arrows", "Crowbar", "1 Cp"],
            ["Warhammer (1d8)", "Shield", "Chain Armor", "Dagger (1d4)", "Sling (1d4)", "Pouch with 10 Bullets", "5x Rations", "3 Torches", "Tinderbox", "50' Rope", "Waterskin", "Small Backpack", "Mallet", "5x Iron Spike", "1 Cp"],
            ["Sword (1d8)", "Shield", "Dagger (1d4)", "Chain Armor", "5x Rations", "Hooded Lantern", "Tinderbox", "50' Rope", "Waterskin", "Large Backpack", "Mallet", "5x Iron Spike", "1 Cp"],
            ...
            ["Greatsword (1d10)", "Chain Armor", "Dagger (1d4)", "Throwing Knives (1d4)", "5x Rations", "Bullseye Lantern", "Tinderbox", "Grappling Hook", "50' Rope", "Waterskin", "Large Backpack", "Crowbar", "5x Iron Spike", "1 Cp"],
            ...
            ["Polearm (1d10)", "Shortsword (1d6)", "Chain Armor", "5x Rations", "3 Torches", "Tinderbox", "50' Rope", "Crowbar", "Waterskin", "Large Backpack", "Whetstone", "Mallet", "5x Iron Spike", "1 Cp"],
            ["Sword (1d8)", "Shield", "Chain Armor", "5x Rations", "Crowbar", "Waterskin", "Small Backpack", "5x Iron Spike", "Shortbow (1d6)", "Whetstone", "1 Cp"],
        ],
        'Magic-User': [
            ["Knife (1d4)", "Garrote (1d2)", "Spellbook", "Waterskin", "Sack", "5x Rations", "11 Cp"],
            ["Dagger (1d4)", "Spellbook", "3 Torches", "Waterskin", "Sack", "50' Rope", "5x Rations", "11 Cp"],
            ["Knife (1d4)", "Spellbook", "3 Torches", "Waterskin", "Rucksack", "Tinderbox", "5x Rations", "1 sp 11 Cp"],
            ["Quarter Staff (1d6)", "Spellbook", "3 Torches", "Waterskin", "Rucksack", "Tinderbox", "50' Rope", "5x Rations", "Steel Mirror", "11 Cp"],
            ["Dagger (1d4)", "Spellbook", "Lamp", "Waterskin", "Rucksack", "Tinderbox", "50' Rope", "5x Rations", "Steel Mirror", "11 Cp"],
            ["Quarter Staff (1d6)", "Grimoire", "Lamp", "Waterskin", "Small Backpack", "Tinderbox", "5x Rations", "15 Cp"],
            ...
            ["Light Crossbow (1d6)", "Quiver With 20 Bolts", "Spellbook", "Lamp", "Waterskin", "Dagger (1d4)", "Rucksack", "Tinderbox", "50' Rope", "5x Rations", "Steel Mirror", "1 Cp"],
            ["Dagger (1d4)", "Spellbook", "Waterskin", "Small Backpack", "Tinderbox", "50' Rope", "Lamp", "3 Flasks of Oil", "Steel Mirror", "Scroll Case", "5x Rations", "4 Cp"],
            ...
            ["Light Crossbow (1d6)", "Quiver With 20 Bolts", "Spellbook", "Large Knife (1d4)", "Waterskin", "Small Backpack", "Tinderbox", "50' Rope", "Lamp", "3 Flasks of Oil", "Steel Mirror", "Scroll Case", "5x Iron Rations", "4 Cp"],
            ["Light Crossbow (1d6)", "Quiver With 20 Bolts", "Spellbook", "Waterskin", "Dagger (1d4)", "Small Backpack", "Tinderbox", "50' Rope", "Lamp", "3 Flasks of Oil", "Steel Mirror", "Scroll Case",  "5x Rations", "4 Cp"],
            ["Shortsword (1d6)", "Spellbook", "Waterskin", "Small Backpack", "Tinderbox", "50' Rope", "Lamp", "3 Flasks of Oil", "Steel Mirror", "Scroll Case", "Holy Water", "5x Rations", "10 sp", "4 Cp"],
            ["Curved Dagger (1d4)", "Spellbook", "Waterskin", "Small Backpack", "Tinderbox", "50' Rope", "Lamp", "3 Flasks of Oil", "Steel Mirror", "Scroll Case", "Holy Water", "5x Rations", "20 sp", "4 Cp"],
        ],
    }
}
